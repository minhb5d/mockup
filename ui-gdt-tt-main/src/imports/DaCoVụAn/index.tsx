...
function TopHeader() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] h-[48px] relative shrink-0 w-full" data-name="Top Header">
      <div aria-hidden className="absolute border-[#e5e7eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center justify-end size-full">
        <div className="content-stretch flex items-center justify-end pb-px px-[16px] relative size-full">
          <Container29 />
        </div>
      </div>
    </div>
...
function Button1() {
  return (
    <a className="cursor-pointer relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Chờ xin ý kiến (4)</p>
        </div>
      </div>
    </a>
  );
...
function Button2() {
  return (
    <a className="cursor-pointer relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Đơn chờ phê duyệt (5)</p>
        </div>
      </div>
    </a>
  );
    ...
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Đã có vụ án ({countByTab("da-co-vu-an")})</p>
        </div>
      </div>
    </div>
  );
...
function Button5() {
  return (
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Trả lại ({countByTab("tra-lai")})</p>
        </div>
      </div>
    </div>
  );
...
function Input2() {
  return (
    <div className="bg-white relative rounded-[4px] shrink-0 w-[189.427px]" data-name="Input">
...
function Container52() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#9ca3af] text-[12px] w-full">
...
function Container71() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[12px] w-full">
          <p className="leading-[16px]">Chọn TTV giải quyết</p>
        </div>
      </div>
    </div>
  );
...
function Container43() {
  return (
    <div className="h-[145px] relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(6,minmax(0,1fr))] grid-rows-[___58px_58px_58px] relative size-full">
        <FilterRow />
        <Container45 />
        <Container47 />
        <Container51 />
...
function FilterGrid() {
  return (
    <div className="bg-white drop-shadow-[0px_1px_1px_rgba(0,0,0,0.05)] h-[225px] relative rounded-[4px] shrink-0 w-full" data-name="Filter Grid">
...
function Button9() {
  return <div className="bg-white col-1 h-[21.5px] ml-0 mt-[2px] relative rounded-[4px] row-1 w-[124px]" data-name="Button" />;
}

function Container77() {
  return (
    <div className="h-[7.5px] relative shrink-0 w-[10.5px]" data-name="Container">
      <svg className="absolute block inset-0 size-full" fill="none" height="7.5" preserveAspectRatio="none" viewBox="0 0 10.5 7.5" width="10.5">
        <g id="Container">
          <path d={svgPaths.p27601000} fill="var(--fill-0, white)" id="Symbol" />
        </g>
      </svg>
    </div>
  );
...
function Button10() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex gap-[8px] items-center ml-[1141px] mt-0 px-[16px] py-[7px] relative rounded-[4px] row-1 w-[142px]" data-name="Button">
      <Container77 />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-white whitespace-nowrap">
        <p className="leading-[16px]">Giao tiểu hồ sơ</p>
      </div>
    </div>
  );
...
function Button11() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex gap-[8px] items-center ml-[1041px] mt-px px-[16px] py-[7px] relative rounded-[4px] row-1 w-[93px]" data-name="Button">
      <Container78 />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
...
function Button12() {
  return (
    <div className="col-1 content-stretch flex flex-col items-center justify-center ml-[1290px] mt-[2px] px-[13px] py-[8px] relative rounded-[4px] row-1 w-[46.456px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container79 />
    </div>
  );
...
function Cell3() {
  return (
    <div className="content-stretch flex flex-col items-center p-[12px] relative shrink-0 w-[204px]" data-name="Cell">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#4b5563] text-[12px] uppercase w-[180px]">
        <p className="leading-[16px]">{`Đương dự & NGƯỜI ĐỨNG ĐƠN`}</p>
      </div>
    </div>
  );
}
...
function Container80() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[12px] w-full">
        <p>
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">CV chuyển:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 31 - 05/06/2026`}</span>
        </p>
      </div>
    </div>
  );
...
function Container82() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Thụ lý mới:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 2329241`}</span>
        </p>
      </div>
    </div>
  );
...
function Container83() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Thẩm phán :</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Đỗ Tất Thắng (TPB3)`}</span>
        </p>
      </div>
    </div>
  );
...
function Data2() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[268px]" data-name="Data">
      <Container80 />
      <Container81 />
      <Container82 />
      <Container83 />
...
function Data3() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[24px] pr-[12px] py-[39.5px] relative shrink-0 w-[193px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">
...
function Data4() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[286px]" data-name="Data">
      <Container86 />
      <Container87 />
      <Container88 />
    </div>
...
function Container89() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[182px]" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[179px]">
        <p>
          <span className="leading-[16px]">{`Mã vụ án: `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">VA26-000681</span>
        </p>
      </div>
    </div>
  );
...
function Container90() {
  return (
    <div className="content-stretch flex flex-col h-[31px] items-start relative shrink-0 w-[182px]" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] h-[32px] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[200px]">
        <p>
          <span className="leading-[16px]">Tên vụ án:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">Vụ án Bị can một - Tội cố ý gây thương tích</span>
        </p>
      </div>
    </div>
  );
...
function Container91() {
  return (
    <div className="content-stretch flex flex-col h-[31px] items-start relative shrink-0 w-[182px]" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] h-[32px] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[200px]">
        <p>
          <span className="leading-[16px]">{`TTV: `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">Nguyễn Văn A</span>
        </p>
      </div>
    </div>
  );
...
function Button13() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex flex-col items-center justify-center ml-0 mt-0 px-[8px] py-[4px] relative rounded-[4px] row-1 w-[95.951px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px]">Chuyển vụ án</p>
      </div>
    </div>
  );
}
...
function BackgroundBorder() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0" data-name="Background+Border">
...
function BackgroundBorder2() {
  return (
    <div className="bg-white relative rounded-[9999px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-transparent border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[9px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-[rgba(12,234,19,0.81)] whitespace-nowrap">
          <p className="leading-[16px]">Đã có vụ án</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder1() {
  return (
    <div className="bg-white relative rounded-[9999px] shrink-0 w-full" data-name="Background+Border">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[9999px]" />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[9px] py-[2px] relative size-full">
          <BackgroundBorder2 />
        </div>
      </div>
    </div>
...
function Data5() {
  return (
    <div className="content-stretch flex flex-col h-[148px] items-center pb-[45.5px] pt-[10px] px-[24px] relative shrink-0 w-[229px]" data-name="Data">
      <Container89 />
      <Container90 />
      <Container91 />
      <BackgroundBorder />
...
function BackgroundBorder3() {
  return (
    <div className="bg-white h-[20px] relative rounded-[9999px] shrink-0 w-[18px]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[9999px]" />
    </div>
  );
}
...
function Data7() {
  return (
    <div className="col-1 content-stretch flex flex-col items-center ml-0 mt-0 pl-[24px] pr-[12px] py-[45.5px] relative row-1 w-[136px]" data-name="Data">
      <BackgroundBorder3 />
      <BackgroundBorder4 />
      <BackgroundBorder5 />
    </div>
...
function TableRow() {
  return (
    <div className="content-stretch flex h-[148px] items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 1">
      <Data />
      <Data1 />
      <Data2 />
      <Data3 />
...
function Container93() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[12px] w-full">
        <p>
          <span className="leading-[16px]">Mã văn thư đến:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic text-black">{` 4943 - 04/06/2026`}</span>
        </p>
      </div>
    </div>
  );
...
function Container94() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Số HSKN:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic text-[#1f2937]">{` 4984 - 04/06/2026`}</span>
        </p>
      </div>
    </div>
  );
...
function Container95() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] items-start leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full" data-name="Container">
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p>
          <span className="leading-[16px]">Thụ lý xét xử:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 2329241`}</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p>
          <span className="leading-[16px]">Thẩm phán :</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Đỗ Tất Thắng (TPTC)`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Hình thức:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Hồ sơ kháng nghị`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start pl-[24px] pr-[12px] py-[39.5px] relative shrink-0 w-[193px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">
        ...
        <p className="leading-[16px] mb-0 whitespace-pre">​</p>
        <p className="whitespace-pre">
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">Người kháng nghị:</span>
          <span className="leading-[16px]">{` VKSNDTC`}</span>
        </p>
      </div>
    </div>
  );
...
function Container102() {
  return (
    <div className="content-stretch flex flex-col h-[31px] items-start relative shrink-0 w-[182px]" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] h-[25px] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[200px]">
        <p>
          <span className="leading-[16px]">Tên vụ án:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">Vụ án Bị can một - Tội cố ý gây thương tích</span>
        </p>
...
function Container103() {
  return (
    <div className="content-stretch flex flex-col h-[23px] items-start relative shrink-0 w-[82px]" data-name="Container">
      <BackgroundBorder7 />
    </div>
  );
}
...
function Data14() {
  return (
    <div className="content-stretch flex flex-col h-[110px] items-center px-[24px] py-[10px] relative shrink-0 w-[229px]" data-name="Data">
      <Container101 />
      <Container102 />
      <BackgroundBorder6 />
      <Container103 />
...
function Data16() {
  return (
    <div className="content-stretch flex flex-col items-center pl-[24px] pr-[12px] py-[45.5px] relative shrink-0 w-[136px]" data-name="Data">
      <BackgroundBorder8 />
    </div>
  );
}
...
function TableRow2() {
  return (
    <div className="content-stretch flex h-[148px] items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 9">
      <Data9 />
      <Data10 />
      <Data11 />
      <Data12 />
...
function Container107() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p className="leading-[16px]">Đã thụ lý</p>
      </div>
    </div>
  );
}
...
function Container109() {
  return <div className="h-[24px] relative shrink-0 w-full" data-name="Container" />;
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Tại:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Tòa án nhân dân khu vực `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">5</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` - Đà `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">Nẵng</span>
        </p>
      </div>
    </div>
...
function Button18() {
  return (
    <div className="bg-[#8b0000] content-stretch flex flex-col items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0 w-[88px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px]">Chuyển vụ án</p>
      </div>
    </div>
...
function BackgroundBorder9() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0 w-[218px]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-solid border-white inset-0 pointer-events-none rounded-[9999px]" />
      <Data24 />
      <Data25 />
    </div>
...
function Container115() {
  return (
    <div className="content-stretch flex flex-col h-[31px] items-start relative shrink-0 w-[82px]" data-name="Container">
      <Container116 />
    </div>
  );
}
...
function Data23() {
  return (
    <div className="content-stretch flex flex-col items-center px-[24px] py-[10px] relative shrink-0 w-[229px]" data-name="Data">
      <Container113 />
      <Container114 />
      <BackgroundBorder9 />
      <Container115 />
...
function TableRow3() {
  return (
    <div className="content-stretch flex h-[148px] items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 11">
      <Data18 />
      <Data19 />
      <Data20 />
      <Data21 />
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[12px] w-full">
        <p>
          <span className="leading-[16px]">Mã đơn:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic text-black">{` 4943`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">CV chuyển:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 12 - 04/06/2026`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Thụ lý mới:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 2329144`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Hình thức:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Đơn khiếu nại tư pháp tố tụng`}</span>
        </p>
      </div>
    </div>
  );
...
function Group2() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="col-1 h-[22.489px] ml-0 mt-0 relative row-1 w-[76.837px]" data-name="image 1">
...
function Data30() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[281px]" data-name="Data">
      <Container118 />
      <Container119 />
      <Container120 />
      <Container121 />
...
function Data31() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[24px] pr-[12px] py-[39.5px] relative shrink-0 w-[184px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">
        <p>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">NĐĐ:</span>
          <span className="leading-[16px]">{` Phạm Hoàng Anh`}</span>
        </p>
      </div>
    </div>
  );
    ...
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          ...
          <span className="leading-[16px]">Ngày:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 02/06/2026`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Tại:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Tòa án nhân dân tỉnh Bắc Ninh`}</span>
        </p>
      </div>
    </div>
  );
...
function Button21() {
  return (
    <div className="bg-[#8b0000] content-stretch flex flex-col items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0 w-[79px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px] mb-0 whitespace-pre">{`Chuyển vụ `}</p>
        <p className="leading-[16px] whitespace-pre">khiếu nại</p>
      </div>
    </div>
  );
}
...
function Data34() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start ml-0 mt-0 pl-[24px] relative row-1 w-[103.783px]" data-name="Data">
      <Button21 />
    </div>
  );
}
...
function Button22() {
  return (
    <div className="bg-[#ef4444] col-1 content-stretch flex flex-col items-center justify-center ml-[110.74px] mt-[0.5px] px-[8px] py-[4px] relative rounded-[4px] row-1 w-[81px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px] mb-0 whitespace-pre">{`Hủy ghép vụ `}</p>
        <p className="leading-[16px] whitespace-pre">khiếu nại</p>
      </div>
    </div>
  );
...
function Container128() {
  return (
    <div className="content-stretch flex flex-col h-[31px] items-start relative shrink-0 w-[80px]" data-name="Container">
      <BackgroundBorder13 />
    </div>
  );
}
...
function Data33() {
  return (
    <div className="content-stretch flex flex-col items-center pr-[24px] py-[10px] relative shrink-0 w-[237px]" data-name="Data">
      <Container126 />
      <Container127 />
      <BackgroundBorder12 />
      <Container128 />
...
function Group5() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
      <div className="[word-break:break-word] col-1 flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center ml-0 mt-0 not-italic relative row-1 text-[10px] text-black w-[123.348px]">
        <p className="mb-0">
          <span className="leading-[16px]">Ngày nhận:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 10/6/2026`}</span>
        </p>
...
function Group12() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <Group5 />
      <div className="col-1 h-0 ml-[7.68px] mt-[22px] relative row-1 w-[122.318px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 122.318 1" width="122.318">
            <line id="Line 1" stroke="var(--stroke-0, #D1D5DB)" x2="122.318" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Data35() {
  return (
    <div className="content-stretch flex flex-col items-center leading-[0] pl-[15px] pr-[12px] py-[45.5px] relative shrink-0 w-[184px]" data-name="Data">
      <Group12 />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center not-italic relative shrink-0 text-[10px] text-black w-[138px]">
        <p className="mb-0">
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">{`Người trả: `}</span>
          <span className="leading-[16px]">Trần Quốc Hạnh</span>
        </p>
        <p>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">Ngày trả</span>
          <span className="leading-[16px]">: 08/06/2026</span>
        </p>
      </div>
    </div>
  );
...
function Data36() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[49.5px] pt-[49px] px-[12px] relative shrink-0 w-[81px]" data-name="Data">
      <Button23 />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Table Row 8">
      <Data28 />
      <Data29 />
      <Data30 />
      <Data31 />
...
function PageContent() {
  return (
    <div className="bg-white h-[1114px] relative shrink-0 w-full" data-name="Page Content">
      <div className="overflow-auto rounded-[inherit] size-full">
...
function Main() {
  return (
    <div className="col-1 content-stretch flex flex-col h-[1163px] items-start ml-0 mt-0 overflow-clip relative row-1 w-[1380px]" data-name="Main">
      <TopHeader />
      <PageContent />
    </div>
  );
...
function DaCoVAn1() {
  return (
    <div className="col-1 content-stretch flex h-[1163px] items-start ml-0 mt-0 relative row-1 w-[1380px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 246) 0%, rgb(243, 244, 246) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="Đã có vụ án">
      <Group14 />
    </div>
  );
}
...
function Group9() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[7px] mt-[284px] place-items-start relative row-1">
      <Group6 />
      <div className="col-1 h-0 ml-[7.68px] mt-[22px] relative row-1 w-[122.318px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 122.318 1" width="122.318">
...
function Group13() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-[97px] place-items-start relative row-1">
      <Group8 />
      <div className="col-1 h-0 ml-[7.68px] mt-[22px] relative row-1 w-[122.318px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 122.318 1" width="122.318">
...
function Group16() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-0 mt-0 place-items-start relative row-1">
      ...
      <Group11 />
      <Group13 />
      <div className="[word-break:break-word] col-1 flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center ml-0 mt-[122px] not-italic relative row-1 text-[10px] text-black w-[148px]">
        <p className="mb-0">
          <span className="leading-[16px]">{`Người thao tác: `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">Nguyễn Hòa</span>
        </p>
        <p>
          <span className="leading-[16px]">Ngày thao tác</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">: 10/6/2026</span>
        </p>
      </div>
    </div>
...
function Group10() {
  return (
    <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[1099px] mt-[543px] place-items-start relative row-1">
      <Group16 />
      <div className="col-1 h-0 ml-[7.68px] mt-[160px] relative row-1 w-[122.318px]">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" height="1" preserveAspectRatio="none" viewBox="0 0 122.318 1" width="122.318">
            <line id="Line 1" stroke="var(--stroke-0, #D1D5DB)" x2="122.318" y1="0.5" y2="0.5" />
          </svg>
...
export default function DaCoVAn() {
  return (
    <div className="content-stretch flex items-center relative size-full" data-name="Đã có vụ án">
      <HtmlBody />
      <Frame2 />
    </div>
  );
