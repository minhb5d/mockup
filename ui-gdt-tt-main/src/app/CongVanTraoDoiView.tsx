...
export function XemBieuMauCongVanModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#f1f5f9", zIndex: 2000, display: "flex", flexDirection: "column", width: "100vw", height: "100vh", overflow: "hidden" }}>
      ...
      <div style={{ background: "#2b579a", color: "#fff", padding: "12px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <button onClick={() => alert("Đã lưu nội dung bản Word thành công!")} style={{ padding: "7px 18px", background: "#15803d", color: "#fff", border: "none", borderRadius: 4, cursor: "pointer", fontSize: 13, fontWeight: 700, fontFamily: F }}>
            💾 Lưu thay đổi
          </button>
      ...
      <div style={{ background: "#fff", borderBottom: `1px solid ${BORDER}`, padding: "8px 16px", display: "flex", alignItems: "center", gap: 6, flexShrink: 0, flexWrap: "wrap", fontSize: 12, fontFamily: F }}>
        ...
        <select
          ...
          style={{ ...selectSt, fontWeight: 700, borderColor: RED, color: RED, background: "#fef2f2" }}
        >
          ...
          {selectedDoc === "to-trinh" ? (
            ...
            <>
                ...
                <tbody>
                  <tr>
                    <td style={{ width: "45%", textAlign: "center", verticalAlign: "top" }}>
                      ...
                      <div style={{ fontSize: "12pt", marginTop: 4 }}>Số: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/TANDTC-V1</div>
              ...
              <div style={{ textAlign: "justify", fontSize: "13.5pt", lineHeight: 1.6, textIndent: "1cm", marginBottom: 14 }}>
                Vụ Giám đốc, kiểm tra I Tòa án nhân dân tối cao nhận được Công văn số […] ngày […/…/…] của [cơ quan xin ý kiến] về việc [trích yếu nội dung công văn xin ý kiến].
              </div>

              <div style={{ textAlign: "justify", fontSize: "13.5pt", lineHeight: 1.6, textIndent: "1cm", marginBottom: 14 }}>
                Qua nghiên cứu Công văn nêu trên và các tài liệu kèm theo, Vụ Giám đốc, kiểm tra I Tòa án nhân dân tối cao có ý kiến như sau:
              </div>
              ...
              <div style={{ textAlign: "justify", fontSize: "13.5pt", lineHeight: 1.6, textIndent: "1cm", marginBottom: 40 }}>
                Trên đây là ý kiến của Vụ Giám đốc, kiểm tra I Tòa án nhân dân tối cao để [cơ quan xin ý kiến] tham khảo trong quá trình giải quyết vụ án theo đúng quy định của pháp luật./.
              </div>
                ...
                <tbody>
                  <tr>
                    <td style={{ width: "50%", textAlign: "left", verticalAlign: "top", fontSize: "11pt" }}>
                      ...
                      <div>- Đ/c [họ và tên] - Phó Chánh án TANDTC (để b/c);</div>
              ...
              {loaiCV === "di" && (
                <>
                  ...
                  <div>
                    ...
                    <input defaultValue="Tòa án nhân dân tối cao" style={inSt} />
                  </div>
                </>
              )}
            </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 10, borderTop: `1px solid ${BORDER}`, padding: "14px 20px", flexWrap: "wrap" }}>
          ...
          {!isSaved ? (
            <button
              ...
              style={{
                padding: "7px 22px", background: "#7f1d1d", color: "#fff", border: "none",
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1350, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ background: "#fff", borderRadius: 8, width: 780, maxWidth: "95vw", maxHeight: "90vh", overflow: "hidden", display: "flex", flexDirection: "column", boxShadow: "0 8px 36px rgba(0,0,0,0.2)" }}>
        ...
        <div style={{ flex: 1, overflow: "auto", padding: 24, display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <div style={{ background: "#f8fafc", borderRadius: 6, border: `1px solid ${BORDER}`, padding: 16 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 6, border: `1px solid ${BORDER}`, padding: 16 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12, fontSize: 12, fontFamily: F }}>
              ...
              <div><span style={{ color: MUTED }}>Tòa ra BA:</span> {row.toaRaBA || "TAND tỉnh Bắc Ninh"}</div>
            </div>
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 6, border: `1px solid ${BORDER}`, padding: 16 }}>
            ...
            <div style={{ fontSize: 12, color: TEXT, fontFamily: F, lineHeight: 1.6, background: "#fafafa", padding: 12, borderRadius: 5, border: `1px solid ${BORDER}` }}>
              Công văn xin ý kiến giải quyết vướng mắc án kinh doanh thương mại liên quan đến hợp đồng tín dụng và xử lý tài sản thế chấp giữa Ngân hàng và Doanh nghiệp. Đề nghị Vụ Giám đốc kiểm tra I TANDTC hướng dẫn áp dụng thống nhất pháp luật.
            </div>
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 6, border: `1px solid ${BORDER}`, padding: 16 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#f8fafc", padding: "8px 12px", borderRadius: 5, border: `1px solid ${BORDER}` }}>
        ...
        {/* Footer */}
        <div style={{ display: "flex", justifyContent: "flex-end", gap: 12, borderTop: `1px solid ${BORDER}`, padding: "14px 20px", background: "#f9fafb" }}>
              ...
              <tr key={r.stt} style={{ background: selectedVB.includes(r.stt) ? "#fff5f5" : idx % 2 === 0 ? "#fff" : "#fafafa" }}>
                ...
                <td style={TD}>
                  {r.trangThai === "Chưa ký số" ? (
                    ...
                    <Badge color={r.trangThai === "Đã phát hành" ? "#065f46" : "#1e40af"} bg={r.trangThai === "Đã phát hành" ? "#d1fae5" : "#dbeafe"}>
                      {r.trangThai}
                    </Badge>
                  )}
                </td>
  ...
  const [noiNhanList, setNoiNhanList] = useState([
    {
      ...
      tenDonViNhan: "Viện kiểm sát nhân dân tối cao",
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, fontFamily: F }}>
                  <thead>
                    <tr style={{ background: BG, borderBottom: `1px solid ${BORDER}` }}>
                      <th style={{ padding: "8px", width: 45, textAlign: "center", fontWeight: 700, color: "#374151" }}>STT</th>
                      <th style={{ padding: "8px", textAlign: "left", fontWeight: 700, color: "#374151", width: 160 }}>LOẠI NƠI NHẬN</th>
                      <th style={{ padding: "8px", textAlign: "left", fontWeight: 700, color: "#374151" }}>TÊN ĐƠN VỊ NHẬN</th>
                      <th style={{ padding: "8px", textAlign: "left", fontWeight: 700, color: "#374151", width: 180 }}>GHI CHÚ</th>
                      <th style={{ padding: "8px", textAlign: "center", fontWeight: 700, color: "#374151", width: 110 }}>THAO TÁC</th>
                    </tr>
                  </thead>
                  <tbody>
                    {noiNhanList.map((item, idx) => {
                      ...
                      return (
                        <tr key={item.id} style={{ borderBottom: "1px solid #f3f4f6", background: "#fff" }}>
                          ...
                          <td style={{ padding: "8px", textAlign: "center" }}>
                            {isEditing ? (
                              <div style={{ display: "flex", gap: 6, justifyContent: "center" }}>
                                <button onClick={() => handleSaveEdit(item.id)} style={{ color: "#16a34a", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>Lưu</button>
                              ...
                              <div style={{ display: "flex", gap: 8, justifyContent: "center", fontSize: 12 }}>
                                <button onClick={() => handleStartEdit(item)} style={{ color: "#2563eb", background: "none", border: "none", cursor: "pointer" }}>✎ Sửa</button>
                    ...
                    {isAdding && (
                      <tr style={{ background: "#fefce8", borderBottom: "1px solid #fef08a" }}>
                        ...
                        <td style={{ padding: "6px", textAlign: "center" }}>
                          <div style={{ display: "flex", gap: 6, justifyContent: "center" }}>
                            <button onClick={handleAddNoiNhan} style={{ color: "#16a34a", background: "none", border: "none", cursor: "pointer", fontWeight: 600 }}>Thêm</button>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ background: "#fff", borderRadius: 8, border: `1px solid ${BORDER}`, padding: 18 }}>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <thead>
                  <tr>
                    {["STT", "GIAI ĐOẠN", "HỌ VÀ TÊN THẨM PHÁN", "CHỨC DANH", "NGÀY PHÂN CÔNG", "NGƯỜI BÚT PHÊ", "GHI CHÚ"].map(h => (
                      <th key={h} style={TH}>{h}</th>
                    ))}
                  </tr>
                </thead>
                <tbody>
                  <tr style={{ background: "#fff" }}>
                    ...
                    <td style={TD}>
                      <span style={{ background: "#dbeafe", color: "#1d4ed8", padding: "2px 10px", borderRadius: 12, fontSize: 11, fontWeight: 700, fontFamily: F }}>
                        TPTC
                      </span>
                    </td>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", tableLayout: "fixed" }}>
                ...
                <tbody>
                  <tr style={{ background: "#fff" }}>
                    <td style={{ ...TD, textAlign: "center", color: MUTED }}>1</td>
                    <td style={{ ...TD, fontWeight: 700 }}>Hoàng Ngọc Chiều</td>
                    <td style={TD}>Thẩm tra viên</td>
                    <td style={TD}>21/07/2026</td>
                    <td style={{ ...TD, fontWeight: 600 }}>Nguyễn Văn Hiền</td>
                    <td style={TD}>Phó Vụ trưởng</td>
                    <td style={TD}>21/07/2026</td>
                  </tr>
                </tbody>
              </table>
...
export default function CongVanTraoDoiView({
  ...
  const filtered = CV_ROWS.filter(r => {
    ...
    if (donViNhanFilter && !r.donViNhan.toLowerCase().includes(donViNhanFilter.toLowerCase())) return false;
  ...
  const labelStyle: React.CSSProperties = {
    fontSize: 11, color: "#4b5563", fontFamily: F, marginBottom: 4, display: "block", fontWeight: 500,
  };
