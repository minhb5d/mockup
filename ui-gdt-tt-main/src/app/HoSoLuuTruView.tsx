...
export function HoSoLuuTruView({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", width: "100%", background: "#f8fafc", overflow: "hidden", fontFamily: F }}>
      {/* Toast */}
      {toastMessage && (
        <div
          style={{
                ...
                >
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px 24px", marginBottom: 24 }}>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: 13, fontWeight: 600, color: TEXT }}>Kho lưu trữ án GĐT – TANDTC Tầng 3</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span style={{ fontSize: 13, fontWeight: 600, color: "#15803d" }}>✓ Đã số hóa và lưu trữ nguyên vẹn</span>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    Tài liệu lưu trữ được quét và niêm phong điện tử theo Quy chế công tác lưu trữ của Tòa án nhân dân tối cao.
                    Bao gồm {selectedItem.soTrang} trang văn bản gốc kèm chữ ký xác nhận của Thẩm tra viên thụ lý.
                  </div>
                </div>
              )}
            </div>
                  ...
                  {[
                    ...
                    <div key={i} style={{ display: "flex", gap: 10, position: "relative" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: 2, fontSize: 11, fontFamily: F }}>
                        ...
                        <span style={{ color: "#475569", lineHeight: 1.4 }}>{h.desc}</span>
