...
function CaseTable({
  ...
  const hasNhanTraCol = tab === "tra-lai";
  const nhanTraHeader = "LÝ DO TRẢ LẠI";
          ...
          {cases.map((c, idx) => (
            ...
            >
              ...
              {hasNhanTraCol && (
                <td style={TD_STYLE}>
                  <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
                    <span style={{ fontSize: 11, fontWeight: 700, color: RED, fontFamily: F }}>Lý do trả:</span>
                    ...
                    {c.ngayTra && <span style={{ fontSize: 11, color: TEXT, fontFamily: F, marginTop: 2 }}>Ngày trả: {c.ngayTra}</span>}
                  </div>
                </td>
              )}
              <td style={{ ...TD_STYLE, textAlign: "center" }}>
...
export default function NhanDonTLVuAnView({
  ...
  return (
    <>
      ...
      <CaseTable tab={activeTab} userRole={userRole} onGiaoTieuHoSo={onGiaoTieuHoSo} />
    </>
  );
}
