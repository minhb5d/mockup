      ...
      <div style={{ padding: "8px 16px", background: "#800000", color: "#fff", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <button
            type="button"
            onClick={() => {
              // TODO(Lane B – Hồ sơ kháng nghị): hiện luôn chọn hồ sơ đầu tiên vì
              // TaiLieuHoSoView chưa trả trạng thái tích chọn ra ngoài. Cần cho phép
              // chọn đúng (các) hồ sơ người dùng tích.
