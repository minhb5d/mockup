    ...
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Đơn chờ phê duyệt ({countByTab("don-cho-phe-duyet")})</p>
        </div>
      </div>
    </div>
  );
...
function Button3() {
  return (
    <div className="relative shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px] text-center whitespace-nowrap">
          <p className="leading-[20px]">Hồ sơ kháng nghị ({countByTab("ho-so-khang-nghi")})</p>
        </div>
      </div>
    </div>
  );
...
function ImageClip() {
  return (
    <div className="absolute inset-[0_-0.6px_0_0]" data-name="image clip">
...
function ImageClip2() {
  return (
    <div className="absolute inset-[0_-0.59px_0_0]" data-name="image clip">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start justify-center overflow-clip pl-[119.33px] pr-[9px] py-[8px] relative rounded-[inherit] size-full">
        <Image2 />
      </div>
    </div>
...
function FilterGrid() {
  ...
  return (
    <div className="shrink-0 w-full" data-name="Filter Grid">
      <SearchFilterPanel expanded={expanded} onToggle={() => setExpanded((v) => !v)} />
    </div>
  );
}

function Button9() {
  return <div className="bg-white col-1 h-[21.5px] ml-0 mt-px relative rounded-[4px] row-1 w-[124px]" data-name="Button" />;
}
...
function Button10() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex gap-[8px] items-center ml-[1190px] mt-0 px-[16px] py-[7px] relative rounded-[4px] row-1 w-[93px]" data-name="Button">
      <Container77 />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-center text-white whitespace-nowrap">
...
function Button11() {
  return (
    <div className="col-1 content-stretch flex flex-col items-center justify-center ml-[1290px] mt-px px-[13px] py-[8px] relative rounded-[4px] row-1 w-[46.456px]" data-name="Button">
      <div aria-hidden className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Container78 />
    </div>
  );
    ...
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] items-start leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full" data-name="Container">
      ...
      <div className="flex flex-col justify-center relative shrink-0 w-full">
        <p>
          ...
          <span className="leading-[16px] text-[#8b0000]">(Dự kiến)</span>
...
function Button12() {
  return (
    <div className="bg-[rgba(223,191,188,0.12)] col-1 gap-x-[10px] gap-y-[10px] grid grid-cols-[repeat(1,minmax(0,1fr))] grid-rows-[repeat(1,minmax(0,1fr))] h-[24px] ml-[93px] mt-0 px-[8px] py-[4px] relative rounded-[24px] row-1 w-[83px]" data-name="Button">
...
function Container86() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#595959] text-[12px] w-[228px] whitespace-pre-wrap">
        <p className="mb-0">
          <span className="leading-[16px]">Vụ án:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{`Mã vụ án:VA26-002012 `}</span>
        </p>
        <p className="mb-0">
          <span className="font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px]">Tên vụ án:</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">{`Vụ án ĐẶNG THÌN DƯƠNG - Tội cố ý gây thương tích hoặc gây tổn hại cho sức khoẻ của người khác `}</span>
        </p>
        <p>
          <span className="font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px]">{`TTV: `}</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">Nguyễn Văn A</span>
        </p>
      </div>
    </div>
  );
...
function BackgroundBorder() {
  return (
    <div className="bg-[#fff7ed] content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#fdba74] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Đơn chờ phê duyệt ({countByTab("don-cho-phe-duyet")})</p>
      </div>
    </div>
  );
}
...
function Data5() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[230px]" data-name="Data">
      <Container86 />
      <BackgroundBorder />
    </div>
  );
...
function Data6() {
  return (
    <div className="content-stretch flex flex-col items-center pl-[24px] pr-[12px] py-[45.5px] relative shrink-0 w-[150px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Hình thức:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Thông báo phát hiện vi phạm `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">PL</span>
        </p>
      </div>
    </div>
  );
...
function Data11() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[10px] pr-[12px] py-[39.5px] relative shrink-0 w-[185px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-[175px] whitespace-pre-wrap">
        <p className="mb-0">
...
function Container96() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] h-[83px] justify-center leading-[0] not-italic relative shrink-0 text-[#595959] text-[12px] w-[228px] whitespace-pre-wrap">
        <p className="mb-0">
          <span className="leading-[16px]">Vụ án:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` `}</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{`Mã vụ án:VA26-002012 `}</span>
        ...
        <p className="mb-0">
          <span className="font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px]">Tên vụ án:</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">{`Vụ án ĐẶNG THÌN DƯƠNG - Tội cố ý gây thương tích `}</span>
        </p>
        <p>
          <span className="font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px]">TTV</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">:</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">{` `}</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">N</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">g</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">u</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">y</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">ễ</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">n</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">{` `}</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">N</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">g</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">ọ</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">c</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">{` `}</span>
          <span className="font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px]">B</span>
        </p>
      </div>
    </div>
  );
...
function Button14() {
  return (
    <div className="bg-[#f8f4ff] gap-x-[10px] gap-y-[10px] grid-cols-[repeat(1,fit-content(100%))] grid-rows-[repeat(1,fit-content(100%))] inline-grid px-[8px] py-[4px] relative rounded-[24px] shrink-0" data-name="Button">
      <div aria-hidden className="absolute border border-[#1c076b] border-solid inset-0 pointer-events-none rounded-[24px]" />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center justify-self-start leading-[0] not-italic relative self-start shrink-0 text-[#1c076b] text-[10px] text-center whitespace-nowrap">
        <p className="leading-[16px]">Đã có Thông báo giải quyết</p>
      </div>
    </div>
  );
}
...
function Container97() {
  return <div className="h-[9px] relative shrink-0 w-full" data-name="Container" />;
}

function BackgroundBorder1() {
  return (
    <div className="bg-[#fff7ed] content-stretch flex h-[22px] items-center justify-center px-[9px] py-[6px] relative rounded-[9999px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#fdba74] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Đơn chờ phê duyệt</p>
      </div>
    </div>
  );
}
...
function TableRow3() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 7">
      <Data8 />
      <Data9 />
      <Data10 />
      <Data11 />
...
function BackgroundBorder3() {
  return (
    <div className="bg-[#fef2f2] relative rounded-[9999px] shrink-0" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#800000] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[9px] py-[2px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[10px] whitespace-nowrap">
          <p className="leading-[16px]">Chưa có hồ sơ tử hình</p>
        </div>
      </div>
    </div>
  );
...
function BackgroundBorder2() {
  return (
    <div className="bg-white content-stretch flex items-center justify-center px-[9px] py-[2px] relative rounded-[9999px] shrink-0 w-[230px]" data-name="Background+Border">
...
function TableRow5() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 9">
      <Data16 />
      <Data17 />
      <Data18 />
      <Data19 />
...
function Data23() {
  return (
    <div className="content-stretch flex flex-col items-center px-[12px] py-[47.5px] relative shrink-0 w-[54px]" data-name="Data">
      <div className="bg-white relative rounded-[4px] shrink-0 size-[16px]" data-name="Input">
        <div aria-hidden className="absolute border border-[#d1d5db] border-solid inset-0 pointer-events-none rounded-[4px]" />
      </div>
    </div>
...
function Data24() {
  return (
    <div className="content-stretch flex flex-col items-center px-[12px] py-[47.5px] relative shrink-0 w-[37px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black text-center whitespace-nowrap">
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#8b0000] text-[12px] w-full">
        <p>
          <span className="leading-[16px]">Mã đơn:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic text-black">{` 4956`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">CV chuyển:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 18 - 05/06/2026`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Thụ lý mới:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` 2329180`}</span>
        </p>
      </div>
    </div>
  );
...
function Data25() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start pl-[12px] relative shrink-0 w-[284px]" data-name="Data">
      <Container107 />
      <Container108 />
      <Container109 />
      <Container110 />
...
function Data26() {
  return (
    <div className="content-stretch flex flex-col items-start pl-[10px] pr-[12px] py-[39.5px] relative shrink-0 w-[193px]" data-name="Data">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black whitespace-nowrap">
        ...
        <p className="whitespace-pre">
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Bold',sans-serif] leading-[16px] not-italic">NĐĐ:</span>
          <span className="leading-[16px]">{` DANH THỊ SÀ RON`}</span>
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px]">Tại:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic">{` Tòa án nhân dân khu vực 1 - Cần Thơ`}</span>
        </p>
      </div>
    </div>
  );
...
function Data28() {
  return (
    <div className="content-stretch flex flex-col items-center px-[24px] py-[45.5px] relative shrink-0 w-[230px]" data-name="Data">
      <BackgroundBorder4 />
    </div>
  );
}
...
function TableRow1() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 5">
      <Data23 />
      <Data24 />
      <Data25 />
      <Data26 />
...
function Container118() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] items-start leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full" data-name="Container">
      ...
      <div className="flex flex-col justify-center relative shrink-0 w-[261px]">
        <p>
          <span className="leading-[16px]">{`Thẩm phán `}</span>
          <span className="leading-[16px] text-[#8b0000]">(Dự kiến)</span>
          <span className="leading-[16px]">:</span>
...
function BackgroundBorder5() {
  return (
    <div className="bg-[#fff7ed] col-1 content-stretch flex items-center justify-center ml-[36.61px] mt-[38px] px-[9px] py-[2px] relative rounded-[9999px] row-1 w-[115.064px]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#fdba74] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Đơn chờ phê duyệt</p>
      </div>
...
function Button19() {
  return (
    <div className="bg-[#2563eb] content-stretch flex flex-col items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0 w-[91px]" data-name="Button">
...
function Data36() {
  return (
    <div className="col-1 content-stretch flex flex-col items-start ml-0 mt-0 pl-[24px] relative row-1 w-[135.7px]" data-name="Data">
      <Button19 />
    </div>
  );
}
...
function Button20() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex flex-col items-center justify-center ml-[135.7px] mt-0 px-[8px] py-[4px] relative rounded-[4px] row-1 w-[94.3px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px]">Thêm vụ án</p>
      </div>
    </div>
  );
}
...
function TableRow2() {
  return (
    <div className="content-stretch flex items-center justify-center mb-[-1px] relative shrink-0 w-full" data-name="Table Row 6">
      <Data31 />
      <Data32 />
      <Data33 />
      <Data34 />
...
function Container125() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[12px] text-black w-full">
        <p>
          <span className="leading-[16px] text-[#111827]">Số HSKN:</span>
          <span className="[word-break:break-word] font-['Be_Vietnam_Pro:Regular',sans-serif] leading-[16px] not-italic text-black">{` 4984 - 04/06/2026`}</span>
        </p>
      </div>
    </div>
  );
...
function Data44() {
  return <div className="col-1 h-[24px] ml-0 mt-0 relative row-1 w-[83.635px]" data-name="Data" />;
}

function Button22() {
  return (
    <div className="bg-[#8b0000] col-1 content-stretch flex flex-col h-[24px] items-center justify-center ml-[54.2px] mt-0 px-[8px] py-[4px] relative rounded-[4px] row-1 w-[175.805px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[16px]">Thêm vụ án</p>
      </div>
    </div>
...
function BackgroundBorder6() {
  return (
    <div className="bg-[#fff7ed] col-1 content-stretch flex items-center justify-center ml-[68.74px] mt-[34px] px-[9px] py-[2px] relative rounded-[9999px] row-1 w-[116.322px]" data-name="Background+Border">
      <div aria-hidden className="absolute border border-[#fdba74] border-solid inset-0 pointer-events-none rounded-[9999px]" />
      <div className="[word-break:break-word] flex flex-col font-['Be_Vietnam_Pro:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ea580c] text-[10px] whitespace-nowrap">
        <p className="leading-[16px]">Đơn chờ phê duyệt</p>
      </div>
...
function PageContent() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[16px] h-[1434px] items-start overflow-auto p-[16px] relative shrink-0" data-name="Page Content">
      <NavBreadcrumbs />
      <TabsSection />
      <FilterGrid />
      <Group />
...
function TlVAnChaCoVAn() {
  return (
    <div className="content-stretch flex h-full items-start relative shrink-0 w-[1380px]" style={{ backgroundImage: "linear-gradient(90deg, rgb(243, 244, 246) 0%, rgb(243, 244, 246) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }} data-name="TL vụ án- Đơn chờ phê duyệt">
      <Main />
    </div>
  );
}

export default function ChaCoVAn() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="Đơn chờ phê duyệt">
      <HtmlBody />
      <TlVAnChaCoVAn />
    </div>
  );
